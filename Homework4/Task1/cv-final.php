...
<?php
  ...
  $job = [
    [
      ...
      'function' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est  reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste'
    ],
    [
      'post'=> 'Web Developer / something.com',
      'period' => 'Mar 2012 - Dec 2014',
      'function' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.'
    ],
    [
      'post'=> 'Graphic Designer / designsomething.com',
      'period' => 'Jun 2010 - Mar 2012',
      'function' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.'
    ],
   
      ];
    ?> 
        
          <h5 class="w3-opacity"><b><?php echo $job[0]['post']; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><span class="w3-tag w3-teal w3-round"><?php echo $job[0]['period']; ?></span></h6>
          <p><?php echo $job[0]['function']; ?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $job[1]['post']; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job[1]['period']; ?></h6>
          <p><?php echo $job[1]['function']; ?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $job[2]['post']; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job[2]['period']; ?></h6>
          <p><?php echo $job[2]['function']; ?></p><br>
        </div>
      </div>
